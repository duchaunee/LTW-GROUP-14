<%-- Document : girlShoes Created on : May 21, 2023, 1:46:31 PM Author : DUC HAU --%>
  ...
  <link rel="stylesheet" href="../CSS/lineClamp.css">-->
      ...
      <link rel="stylesheet" type="text/css"
        href="${pageContext.request.contextPath}/FE/Footer/footer.css" />
      <link rel="stylesheet" type="text/css"
        href="${pageContext.request.contextPath}/FE/Header/header.css" />
      <link rel="stylesheet" type="text/css"
        href="${pageContext.request.contextPath}/FE/GirlShoes/girlShoes.css" />
    </head>
